...
const useFileUpload = () => {
    ...
    const uploadFile = async (file) => {
        ...
        data.append("upload_preset", "bookhouse-preset");
        data.append("cloud_name", "daqnsxiyw");

        const fileUploadResponse = await fetch("https://api.cloudinary.com/v1_1/daqnsxiyw/raw/upload", {
            method: "POST",
            body: data,
          }).catch((error) => {
